...
FactoryGirl.define do
  ...
  schedule_futbol = IceCube::Schedule.new(start_futbol)
  schedule_futbol.add_recurrence_rule IceCube::Rule.weekly.count(1)
  ...
  factory :event do
    ...
    # last_call 4 #hours //idem rush_start //delete TODO:delete
    rush_start 4 #hours
    ...
    factory :every_saturday_event do
